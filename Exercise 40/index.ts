...
let album1:any=make_album("Imran Khan", "Unforgettable");
let album2:any=make_album("Kanye West", "College Dropout", 21);
let album3:any=make_album("Abrar ul Haq", "Billo de ghar");
console.log(album1);
console.log(album2);
console.log(album3);
